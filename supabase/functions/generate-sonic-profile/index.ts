...
const DESCRIPTOR_GLOSSARY: Array<{
  ...
  { slug: "nocturnal",   category: "emotional_tone", means: "Night-time tension, after-hours atmosphere, shadowy urban mood, or distinctly late-night sonic framing. Requires clearly audible night-coded production: dark synth pads, after-hours reverb, shadowy bass, or explicitly nocturnal arrangement.", notMeans: ["calm", "peaceful", "euphoric", "triumphant", "merely cool-toned or moody — nocturnal requires night-specific sonic coding, not just dark mood", "merely slow or reflective — nocturnal is atmospheric framing, not tempo or introspection"] },
  ...
  { slug: "hazy",        category: "texture", means: "Blurred sonic edges, atmospheric diffusion, or dreamlike sonic softness. Requires smeared or softened textures, reverb-heavy atmospheric diffusion, or dreamlike sonic fog. The sonic image must have visibly softened definition.", notMeans: ["merely slow or emotionally reflective — hazy is a production texture, not a mood", "clean or crisp production", "dry or precise mixing", "mellow or restrained — hazy requires audible diffusion, not just low energy", "emotionally distant — detachment is not blur"] },
  // arrangement_energy_arc
