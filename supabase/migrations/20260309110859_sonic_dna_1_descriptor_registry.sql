-- =============================================================================
-- Sonic DNA System — Migration 1 of 3
-- Creates descriptor_registry table
-- =============================================================================
...
CREATE TABLE public.descriptor_registry (
  ...
  -- Tier 1: public clickable (SEO-indexed, navigable)
  -- Tier 2: UI only (shown but not indexed)
  -- Tier 3: internal only (used for scoring, never shown)
