...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  energy_posture:          "bg-blue-500/15 text-blue-300 border-blue-500/30",
  groove_character:        "bg-indigo-500/15 text-indigo-300 border-indigo-500/30",
  texture:                 "bg-cyan-500/15 text-cyan-300 border-cyan-500/30",
  spatial_feel:            "bg-sky-500/15 text-sky-300 border-sky-500/30",
